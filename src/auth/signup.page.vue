...
export default {
  ...
  computed: {
    ...
    validEmail() {
      return (
        !!this.email && emailRegex.test(this.email) && !this.email.includes(" ")
      );
    },
    validPassword() {
      return !!this.password && this.password.length >= 12;
    }
  },
  data() {
    return {
      ...
      email: "",
      emailInfo:
        "Please enter a valid email address so you can verify your account. We won't email you unless it's important.",
      infoSvg: infoIcon,
      loading: false,
      message: "",
      password: "",
      ...
      authApi
        ...
        .then(
          ...
          () => {
            ...
            this.message =
              "Signup failed. Please check your email/password and try again.";
          }
        );
    }
  }
